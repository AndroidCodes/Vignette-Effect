...
//    private static final LoggerFactory.Logger logger = LoggerFactory.getLogger(TAG);
    ...
    private Paint mVignettePaint, mControlPointPaint, mBlackPaint;
...
//        logger.info("onLayoutChanged: %d, %d, %d, %d", left, top, right, bottom);
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (!mVignetteRect.isEmpty()) {
            ...
            canvas.drawRect(mVignetteRect.centerX() - radiusX - sControlPointSize, mVignetteRect.centerY() - radiusY - sControlPointSize,
                    mVignetteRect.centerX() - radiusX + sControlPointSize, mVignetteRect.centerY() - radiusY + sControlPointSize, mControlPointPaint);
...
//        logger.info("onDown");
        ...
        rect.set(centerX - radiusX - sControlPointTolerance, centerY - radiusY - sControlPointTolerance, centerX - radiusX + sControlPointTolerance,
...
//        logger.info("updateGradientShader: %f", value);
        ...
        mGradientShader = new RadialGradient(0, 0, 1, colors, anchors, Shader.TileMode.CLAMP);
